class FestivalsController < ApplicationController
  ...
  def index
    @festivals = Festival.search(params[:search]).includes(:festival_years).where('festival_years.year = ?', params[:year]).order(sort_column + " " + sort_direction).paginate(:page => params[:page])
